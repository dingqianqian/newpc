...
@section("content")
    <div class="content-wrapper">
        ...
        <section class="content container-fluid">
            <form class="form-horizontal" action="{{url("admin/news/update")}}/{{$newsInfo['id']}}" method="post"
            ...
            <!--新闻分类-->
                <div class="form-group">
                    ...
                    <select id="goodsNames" class="selectpicker z-select" data-live-search="true" name="type">
                        <option value="2" @if($newsInfo['type']==2) selected @endif>新闻|公告</option>
                        <option mustard value="0" @if($newsInfo['type']==0) selected @endif>新闻</option>
                        <option value="1" @if($newsInfo['type']==1) selected @endif>公告</option>
                    </select>
                </div>
                <!--新闻标题-->
                <div class="form-group">
                    ...
                    <div class="col-xs-8 col-md-9">
                        <input type="text" class="form-control" placeholder="新闻标题" name="title" value="{{$newsInfo['title']}}">
                    </div>
                </div>
                <!--新闻作者-->
                <div class="form-group">
                    ...
                    <div class="col-xs-8 col-md-9">
                        <input type="text" class="form-control" id="dateinfo" placeholder="新闻作者" name="authour" value="{{$newsInfo['authour']}}">
                    </div>
                </div>
                <!--新闻描述-->
                <div class="form-group">
                    ...
                    <div class="col-xs-8 col-md-9">
                        <textarea name="description" rows="5" cols="56" class="z-textarea"
                                  placeholder="新闻描述">{{$newsInfo['description']}}</textarea>
                    </div>
                </div>
                <!--图片-->
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <div class="col-xs-8 col-md-9">
                        <textarea id="editor" name='content' type="text/plain"
                                  style="width:100%;height:500px;">{!! $newsInfo['content'] !!}</textarea>
                    </div>
                </div>
            {{csrf_field()}}
            <!--提交-->
