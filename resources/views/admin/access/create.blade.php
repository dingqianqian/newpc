...
@section("content")
	...
	<div class="content-wrapper">
		...
		<section class="content container-fluid">
			<form class="form-horizontal" action="{{url('admin/access/add')}}" method="post">
				@if (count($errors) > 0)
				...
				<div class="form-group">
					...
					<div class="col-xs-6 col-sm-4">
						<input type="text" class="form-control" id="commpaixu" name="route_name">
					</div>
				</div>
				<!--权限描述-->
				<div class="form-group">
				...
				<div class="form-group">
					...
					<div class="col-xs-6 col-sm-4">
						<input type="text" class="form-control" id="fenlei" name="sort">
					</div>
				</div>
				<!--权限是否显示-->
				<div class="form-group">
