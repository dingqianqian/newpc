...
@section("content")
    ...
    <div class="content-wrapper">
        ...
        <section class="content container-fluid">
            <form class="form addchognzhi" method="post" action="{{url("admin/rechargeType/update")}}/{{$rechargeTypeInfo['id']}}" enctype="multipart/form-data">
                @if (count($errors) > 0)
                ...
                <div class="row">
                    ...
                    <div class="col-md-5 col-xs-9">
                        <input type="text" class="form-control" placeholder="填写充值金额" name="money" value="{{$rechargeTypeInfo['money']}}">
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-4 col-xs-3 text-right"><b>返现金额 :</b></div>
                    <div class="col-md-5  col-xs-9">
                        <input type="text" class="form-control" placeholder="填写返现金额" name="give_back" value="{{$rechargeTypeInfo['give_back']}}">
                    </div>
                </div>
                    <div class="row">
                        <div class="col-md-4 col-xs-3 text-right"><b>排序 :</b></div>
                        <div class="col-md-5  col-xs-9">
                            <input type="text" class="form-control" placeholder="充值排序" name="sort" value="{{$rechargeTypeInfo['sort']}}"/>
                        </div>
                    </div>
                {{--<div class="row">
