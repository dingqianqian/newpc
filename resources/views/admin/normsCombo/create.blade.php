...
@section("content")
	...
	<a href="{{route("normsCombo.list")}}" class="btn btn-default btn-xs"><i></i>SKU列表</a>
		...
		<section class="content container-fluid">
			...
			<form class="form-horizontal" method="post" action="{{url("admin/normsCombo/add")}}">
				...
				<div class="form-group">
					...
					<div class="col-xs-6 col-sm-4">
						<input type="text" class="form-control" placeholder="请填写库存数量" name="stock">
					</div>
				</div>
				<!--销售库存-->
				<div class="form-group">
					...
					<div class="col-xs-6 col-sm-4">
						<input type="text" class="form-control" placeholder="请填写促销库存数量" name="sale_stock">
					</div>
				</div>
				<!--商品单价-->
				<div class="form-group">
					...
					<div class="col-xs-6 col-sm-4">
						<input type="text" class="form-control" placeholder="请填写商品单价" name="piece_price">
					</div>
				</div>
					<!--商品单价-->
					<div class="form-group">
						...
						<div class="col-xs-6 col-sm-4">
							<input type="text" class="form-control" placeholder="请填写商品单价" name="small_piece_price">
						</div>
					</div>
				<!--易购价-->
				<div class="form-group">
					...
					<div class="col-xs-6 col-sm-4">
						<input type="text" class="form-control" placeholder="请填写商品易购价" name="single_price">
					</div>
				</div>
					<!--冰点价-->
					<div class="form-group">
						...
						<div class="col-xs-6 col-sm-4">
							<input type="text" class="form-control" placeholder="请填写商品冰点价格" name="sale_single_price">
						</div>
					</div>
				...
				<div class="form-group">
					...
					<div class="col-xs-6 col-sm-4"  style="margin-top: 5px;">
						...
						<div class="col-xs-4 z-diva">
							<input type="radio" name="f_goods_details_img_id" class="a" value="{{$v['id']}}"/>
							<p class="z-img">
								<img src="{{$v['url']}}"/>
							</p>
				...
				<div class="form-group">
					...
					<div class="col-xs-6 col-sm-4"  style="margin-top: 5px;">
						...
						<div class="col-xs-4 z-div">
							<input type="radio" name="f_goods_img_id" id="" value="{{$v['id']}}"/>
						...
						<div class="col-xs-6 col-sm-4"  style="margin-top: 5px;">
							@foreach($goodsImgInfo as $k=>$v)
								<div class="col-xs-4 z-div z_checkbox">
									<input type="checkbox" name="f_norms_image[]" id="" value="{{$v['id']}}"/>
