...
@section("content")
    ...
    <div class="content-wrapper">
        ...
        <section class="content container-fluid">
            ...
            @endif
            <form class="form-horizontal" action="{{url("admin/joinHotel/add")}}" method="post" enctype="multipart/form-data">
                <!--酒店名称-->
                ...
                <div class="form-group">
                    ...
                    <input type="file" class="col-xs-4" id="shang" name="image_url">
                </div>
                {{csrf_field()}}
                <!--提交-->
