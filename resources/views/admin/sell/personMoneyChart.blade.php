            ...
            <div class="panel panel-default">
                <div class="panel-body">
                    ...
                    <span class="pull-right">
                        <a href="{{route("moneyChart.list")}}" class="btn btn-default btn-xs"><i></i>成交排行</a>
                    </span>
                </div>
            </div>
        </section>
        ...
        <section class="content container-fluid">
            ...
            <div class="panel panel-default search">
                <div class="panel panel-body">
                    <form class="form-inline" action="{{url("admin/sell/personMoneyChart")}}/{{$id}}">
                        <!--日期1-->
                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered">
                            ...
                            <tr style="font-size: 1.2em;">
                                <td><b><span>{{$employeeInfo['username']}}</span>----注册用户成交额</b></td>
                            </tr>
                            <tr>
    ...
    <script>
        $('#chartregist').highcharts({
            ...
            yAxis: {
                ...
                max:{{intval(max($moneyInfo)*2)?getInt(intval(max($moneyInfo)*2)):100}},
                min: 0,
                tickInterval: {{intval(max($moneyInfo)*2)?floor(getInt(intval(max($moneyInfo)*2))/10):100/10}}
            }
            ,
            legend: {
                enabled: false
