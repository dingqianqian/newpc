		...
		<section class="content container-fluid">
			...
			<div class="panel panel-default search">
				<div class="panel panel-body" id="xiugaiInput">
					<form class="form-inline" action="{{route('money.list')}}" method="get">
						<!--日期-->
				...
				<table class="table table-bordered table-hover text-center">
					...
					@foreach($userInfo['data'] as $k=>$v)
						<tr>
							...
							<td>
								<a href="{{url("admin/sell/info")}}/{{$v['id']}}/4" class="edit" title="查看详情"><img src="{{asset("admin/img/details.png")}}" alt=""></a>
							</td>
						</tr>
					@endforeach
					</tbody>
