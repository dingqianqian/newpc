			...
			<section class="content container-fluid">
				...
				<div class="panel panel-default dl_Commodity_panel" style="font-weight: normal">
					<div class="panel panel-body" id="xiugaiInput">
						...
						<form class="form-inline" action="{{route('register.list')}}" method="get" id="export">
							<!--日期-->
				...
				{{--<input type="checkbox" id="checkAll" value="option1">--}}编号
						...
						@foreach($userInfo['data'] as $k=>$v)
							<tr>
								...
								<td>
									<a href="{{url("admin/sell/info")}}/{{$v['id']}}/0" class="edit" title="查看详情"><img src="{{asset("admin/img/details.png")}}" alt=""></a>
								</td>
							</tr>
							@endforeach
						</tbody>
...
@section("js")
	...
	<script>
		...
		function exports()
		{
		    ...
		    location.href="{{url("admin/sell/registerExport")}}?"+data;
		}
		// 下拉搜索
		$(function() {
