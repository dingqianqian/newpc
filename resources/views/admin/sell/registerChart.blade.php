        ...
        <section class="content container-fluid">
            ...
            <div class="panel panel-default dl_Commodity_panel">
                <div class="panel panel-body" id="xiugaiInput">
                    <form class="form-inline" action="{{route("registerChart.list")}}" id="export">
                        <!--日期1-->
                        <div class="form-group">
                            <span>开始日期:</span>
                            <input class="datainp form-control input-sm" id="dateinfo" type="text" placeholder="请选择" name="min_time" value="{{$info['min_time']}}">
                        </div>
                        {{--<span>&nbsp;&nbsp;&nbsp;</span>--}}
                        <!--日期2-->
                        <div class="form-group">
                                ...
                                <td class="table-responsive">
                                    <table class="table ly_table">
                                        ...
                                        <tr>
                                            ...
                                            <th class="col-md-3 text-center">注册量</th>
                                        ...
                                        <tr>
                                            ...
                                            <td>{{count($v['user'])}}</td>
                                                <td>@if($v['f_area_id']==0)
                                                    ...
                                                    @endif</td>
                                            <td>
                                                <a href="{{url("admin/sell/personRegisterChart")}}/{{$v['id']}}">{{$v['username']}}</a>
                                            </td>
                                        </tr>
                                            @endforeach
                                        </tbody>
...
<script>
    ...
    function exports()
    {
        ...
        location.href="{{url("admin/sell/registerChartExport")}}?"+data;
    }
