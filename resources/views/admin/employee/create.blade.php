			...
			<form class="form-horizontal" action="{{url('admin/employee/add')}}" method="post">
				...
				<div class="form-group">
					...
					<div class="col-xs-6 col-sm-4">
						<input type="text" class="form-control" id="username" name="signin_name">
					</div>
				</div>
				<!--密码-->
				<div class="form-group">
				...
				<div class="form-group">
					...
					<div class="col-xs-6 col-sm-4">
						<input type="text" class="form-control" id="idcard" name="pid">
					</div>
				</div>
					<!--微信号-->
				<div class="form-group">
					...
					<div class="col-xs-6 col-sm-4">
						<input type="text" class="form-control" id="wcart" name="wechat_id">
					</div>
				</div>
					<!--QQ-->
				<div class="form-group">
					...
					<div class="col-xs-6 col-sm-4">
						<input type="text" class="form-control" id="qq" name="qq_id">
					</div>
				</div>
					<!--生日-->
				<div class="form-group">
					...
					<div class="col-xs-6 col-sm-4 datep">
						<input type="text" class="form-control datainp" id="dateinfo" name="birthday_time">
					</div>
				</div>
					<!--性别-->
				<div class="form-group">
					...
					<div class="col-xs-4 radio" id="sex">
						<label>
							<input type="radio" name="e_gender" value="M"><span>男</span>
						</label>
						<label>
							<input type="radio" name="e_gender" value="F"><span>女</span>
						</label>
					</div>
				</div>
					<!--部门-->
				...
				<div class="form-group">
					...
					<div data-toggle="distpicker" id="cacon" class="clear">
						<select name="addr_provinc" class="col-xs-1" id="province2" data-province=" 选择省"></select>
						<select name="addr_city" class="col-xs-1" id="city2" data-city="选择市"></select>
						<select class="col-xs-1" name="addr_town" id="district2" data-district="选择区"></select>
					</div>
				</div>
				{{csrf_field()}}
				<!--提交-->
