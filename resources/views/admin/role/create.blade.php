...
@section("content")
	<div class="content-wrapper">
		...
		<section class="content container-fluid">
			<form class="form" id="ly_form" action="{{url("admin/role/add")}}" method="post">
				<div>
					<!--描述-->
					<div class="row">
						<div class="col-md-4 col-xs-4 text-right ab"><b>角色名</b></div>
						<div class="col-md-3 col-xs-6 ainput">
							<input type="text"  name="name" class="form-control input-xs">
						</div>
						<span>*</span>
					</div>
					<div class="row">
						...
						<div class="col-md-4 col-xs-7 ainput">
							<textarea class="form-control" name="description" rows="4" style="resize: none;"></textarea>
						</div>
						<span>*</span>
					</div>
				</div>
				...
				<div class="row">
					<div class="col-md-2 col-xs-12 checkAll">
						<div class="checkbox">
							<label>
								<input type="checkbox" name="role_id[]" value="{{$v['id']}}"><b>{{$v['name']}}</b>
							</label>
						</div>
					</div>
					<div class="col-md-9 col-xs-12 labelCon">
						<div class="checkbox">
							...
							<label>
								<input type="checkbox" name="role_id[]" value="{{$v1['id']}}">{{$v1['name']}}
							</label>
								@endforeach
								@endif
						</div>
