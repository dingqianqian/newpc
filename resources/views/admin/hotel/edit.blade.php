...
@section("content")
	...
	<div class="content-wrapper">
		...
		<section class="content container-fluid">
			...
			@endif
			<form class="form-horizontal" method="post" action="{{url("admin/hotel/update")}}/{{$goodsTypeInfo['id']}}" enctype="multipart/form-data">
				<!--商品名-->
				<div class="form-group">
					<label for="commname" class="control-label col-xs-4">酒店名称</label>
					<div class="col-xs-6 col-sm-4">
						<input type="text" class="form-control" id="commname" name="name" value="{{$goodsTypeInfo['name']}}">
					</div>
				</div>
				<!--商品排序-->
				<div class="form-group">
				...
				<div class="form-group">
					...
					<div class="col-xs-4">
						<input type="text" class="form-control" id="fenlei" name="index" value="{{$goodsTypeInfo['index']}}">
					</div>
				</div>
				<!--受否显示-->
				<div class="form-group">
					...
					<div class="col-xs-4 radio" id="show">
						<label>
							<input type="radio" value="0" name="is_show" @if($goodsTypeInfo['is_show']==0) checked @endif >是
						</label>
						<label>
							<input type="radio" value="1" name="is_show" @if($goodsTypeInfo['is_show']==1) checked @endif >否
						</label>
					</div>
				</div>
				<!--上传-->
