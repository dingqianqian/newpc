...
@section("content")
    ...
    @endcomponent
<div class="er-title">
    <p><a href="{{url('/')}}">首页</a>/<span>酒店用品</span></p>
</div>
<ul class="showUl clear">
    <li @if($id==5)class="sec" @endif><a href="{{url('category/hotel/5')}}">客房卷纸</a></li>
    <li @if($id==6)class="sec" @endif><a href="{{url('category/hotel/6')}}">客房用品</a></li>
    <li @if($id==7)class="sec" @endif><a href="{{url('category/hotel/7')}}">清洁用品</a></li>
    <li @if($id==10)class="sec" @endif><a href="{{url('category/hotel/10')}}">电器专区</a></li>
    <li @if($id==149)class="sec" @endif><a href="{{url('category/hotel/149')}}">针织布草</a></li>
    <li @if($id==9)class="sec" @endif><a href="{{url('category/hotel/9')}}">有偿用品</a></li>
    <li @if($id==160)class="sec" @endif><a href="{{url('category/hotel/160')}}">布草洗涤</a></li>
    <li @if($id==216)class="sec" @endif><a href="{{url('category/hotel/216')}}">私人定制</a></li>
