...
@section("content")
    ...
    @endcomponent
    <div class="er-title">
        <p><a href="{{url('/')}}">首页</a>/<span>居家用品</span></p>
    </div>
    <ul class="showUl clear">
        <li @if($id==53)class="sec"@endif><a href="{{url('category/home/53')}}">居家用纸</a></li>
        <li @if($id==52)class="sec"@endif><a href="{{url('category/home/52')}}">针织家纺</a></li>
        <li @if($id==164)class="sec"@endif><a href="{{url('category/home/164')}}">清洁用品</a></li>
        <li @if($id==158)class="sec"@endif><a href="{{url('category/home/158')}}">居家装修</a></li>
        <li @if($id==54)class="sec"@endif><a href="{{url('category/home/54')}}">洗护专区</a></li>
    </ul>
    <!--<div class="hideUl">
        <ul class="clear">
