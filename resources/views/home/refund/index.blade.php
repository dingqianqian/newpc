@extends("home.layout.layout")
        @section("title","退款")
        @section("css")
            <link rel="stylesheet" href="{{asset('home/css/refund/tuikuan.css')}}">
        @endsection
@section("content")
...
<div class="oStep clear">
    ...
    <div class="tStepCont">
        ...
        <p style="width: 100%;text-align: center;margin: 264px 0 0 0;">
            ...
            <span style="display: inline-block;vertical-align: middle;font-size: 20px;color:#666;">您暂无退款信息~</span>
        </p>
        @else
        <!--有商品时-->
        <p class="lieB">
        ...
        <ul class="clear">
            ...
            <li class="clear">
                ...
                <div class="inR">
                    ...
                    <div class="shijian"><span>{{date("Y-m-d H:i:s",$v['refund_time'])}}</span></div>
                    <div class="chaKan">
                        @if($v['f_order_form_status_id']==7)
                        <a href="{{url('refund/info')}}/{{$v['no']}}" class="suc">退款完成</a>
                        <img class="deleteAd" ids="{{$v['id']}}" src="{{asset('home/images/refund/lajitong.png')}}" alt="">
                            @else
                            <a href="{{url('refund/info')}}/{{$v['no']}}">查看进度</a>
                        @endif
                    </div>
                </div>
            </li>
            ...
            <li class="clear">
                ...
                <div class="inR">
                    ...
                    <div class="chaKan">
                        <a href="javascript:;" class="suc">查看进度</a>
                        <img class="deleteAd" src="img/lajitong.png" alt="">
                    </div>
                </div>
            </li>--}}
        </ul>
