...
@section("content")
    ...
    <!--右侧内容-->
        <div class="tStepCont">
            <ul>
                <li><a href="{{url('safe/password/stepOne')}}" class="sec">修改登录密码</a></li>
                <li><a href="{{url('safe/paycode/checkInfo')}}">支付密码管理</a></li>
                <li><a href="{{url('safe/username/stepOne')}}">修改验证手机</a></li>
            </ul>
            <div class="box">
                <img src="{{asset('home/images/safe/dengOne.png')}}" alt="">
                <form action="{{url('safe/password/stepTwo')}}" method="post">
