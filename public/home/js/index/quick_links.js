jQuery(function($){
	...
	quickDataFns = {
		...
		// mpbtn_recharge:{
		// 	title: '钱包充值',
		// 	content: '<div class="ibar_plugin_content"><form target="_blank" class="ibar_recharge_form"><div class="ibar_recharge-field"><label>账号</label><div class="ibar_recharge-fl"><div class="ibar_recharge-iwrapper"><input type="text" name="19" placeholder="用户账号" /></div><i class="ibar_recharge-contact"></i></div></div><div class="ibar_recharge-field"><label>金额</label><div class="ibar_recharge-fl"><div class="ibar_recharge-iwrapper"><input type="text" name="19" placeholder="输入充值金额" /></div><i class="ibar_recharge-contact"></i></div></div><div class="ibar_recharge-btn"><input type="submit" value="立即充值" /></div></form></div>',
		// 	init: $.noop
		// }
	};
